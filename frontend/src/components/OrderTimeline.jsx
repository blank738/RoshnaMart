      ...
      <div className="flex items-center gap-3 p-4 bg-red-50 text-red-700 rounded-xl border border-red-200">
        ...
        <div>
          ...
          <p className="text-xs text-red-600 mt-0.5">
            This order has been cancelled. Refund and inventory
            updates are handled according to the order policy.
          </p>
        </div>
      </div>
    );
          ...
          {STEPS.map((step, idx) => {
            ...
            return (
              ...
              >
                ...
                <span
                  className={`text-[11px] font-semibold mt-2 text-center max-w-[80px] leading-tight ${isDone
