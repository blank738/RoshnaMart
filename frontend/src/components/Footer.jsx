    ...
    <footer className="bg-slate-900 text-slate-300 pt-16 pb-12 mt-20 border-t border-slate-800">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400 mt-0.5">
                100% Admin vetted quality merchants
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400 mt-0.5">
                Hassle-free pickups & instant refunds
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400 mt-0.5">
                Dedicated customer & seller assistance
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="container py-12 grid grid-cols-1 md:grid-cols-5 gap-8">
        ...
        <div className="md:col-span-2 space-y-4">
          <Link
            to="/"
            className="flex items-center gap-2.5 font-bold text-2xl text-white"
          >
            ...
            <span>
              ROSHNA<span className="text-emerald-400">MART</span>
            </span>
          </Link>

          <p className="text-sm text-slate-400 max-w-sm leading-relaxed">
            RoshnaMart is a modern multi-vendor marketplace connecting
            passionate independent sellers and discerning buyers. One checkout,
            limitless variety, transparent commissions.
          </p>
        ...
        <div className="space-y-3">
          ...
          <ul className="space-y-2 text-sm text-slate-400">
            ...
            <li>
              <a
                href="mailto:support@roshnamart.com"
                className="hover:text-emerald-400 transition"
              >
                support@roshnamart.com
              </a>
            </li>
          </ul>
        </div>
      ...
      <div className="container pt-8 border-t border-slate-800 text-xs text-slate-500 flex flex-col sm:flex-row items-center justify-between gap-4">
        <p>
          © {new Date().getFullYear()} RoshnaMart Marketplace. All rights
          reserved.
        </p>
